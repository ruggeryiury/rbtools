...
def image_converter(src_path: str, dest_path: str, width: int = 256, height: int = 256, interpolation: str = 'LANCZOS', quality: int = 100) -> str:
  try:
...
if __name__ == '__main__':
  ...
  status = image_converter(arg.src_path, arg.dest_path, arg.width, arg.height, arg.interpolation, arg.quality)