...
def image_buffer_processor(img_base64: str, format: str, width: int = 256, height: int = 256, interpolation: str = 'LANCZOS', quality: int = 100) -> str:
...
if __name__ == '__main__':
  ...
  data_url = image_buffer_processor(arg['imgBase64'], arg['format'], arg['width'], arg['height'], arg['interpolation'], arg['quality'])
  if arg['printResults']:
    print(data_url)